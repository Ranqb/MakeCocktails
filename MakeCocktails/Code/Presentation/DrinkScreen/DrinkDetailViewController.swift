...
{
  func displaySomething(viewModel: DrinkDetail.Something.ViewModel)
}

class DrinkDetailViewController: UIViewController, DrinkDetailDisplayLogic
{
  ...
  func doSomething()
  {
    let request = DrinkDetail.Something.Request()
